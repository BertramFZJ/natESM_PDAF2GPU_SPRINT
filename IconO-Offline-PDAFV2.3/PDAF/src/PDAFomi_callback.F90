...
! *** local variables ***
  ...
  ! WRITE(0,*) 'RSE: CALL PDAFomi_g2l_obs_cb #1 n_obstypes = ', n_obstypes
...
! *******************************************************
  ...
  ! WRITE(0,*) 'RSE: EXIT PDAFomi_g2l_obs_cb #1'
...
! *** local variables ***
  ...
  ! WRITE(0,*) 'RSE: CALL PDAFomi_init_obs_l_cb #1 n_obstypes = ', n_obstypes
...
! *******************************************
  ...
  ! WRITE(0,*) 'RSE: EXIT PDAFomi_init_obs_l_cb #1'
