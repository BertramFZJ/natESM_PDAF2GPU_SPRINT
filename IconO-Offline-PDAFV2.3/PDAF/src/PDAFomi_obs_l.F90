...
! *******************************************
    ...
    ! WRITE(0,*) 'RSE: CALL PDAFomi_g2l_obs #1'
    ...
    ! WRITE(0,*) 'RSE: EXIT PDAFomi_g2l_obs #1'
...
! *** Arguments ***
    ...
    ! WRITE(0,*) 'RSE: CALL PDAFomi_init_obs_l #1'
...
! *******************************************
    ...
    ! WRITE(0,*) 'RSE: EXIT PDAFomi_init_obs_l #1'
...
! *******************************************
    ...
    ! WRITE(0,*) 'RSE: CALL PDAFomi_g2l_obs_internal #1'
    ...
    ! WRITE(0,*) 'RSE: EXIT PDAFomi_g2l_obs_internal #1'
